import { serverError, ok } from '../../presentation/helppers/http-helper'
...
const makeLogErrorRepositoy = (): LogErrorRepository => {
...
const makeSut = (): SutTypes => {
  ...
  const logErrorRepositoryStub = makeLogErrorRepositoy()
